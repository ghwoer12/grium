...
public class UserDto {
	...
	public UserDto(String email, String password, String name, String photo, String phone) {
		super();
		this.email = email;
	...
	public String toString() {
		return "UserDto [email=" + email + ", password=" + password + ", name=" + name + ", photo=" + photo + ", phone="
				+ phone + "]";
	}
}